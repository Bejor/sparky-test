...
## Environments
- Preview: https://main--sparky-test--Bejor.aem.page/
- Live: https://main--sparky-test--Bejor.aem.live/
...
1. Open the `sparky-test` directory in your favorite IDE and start coding :)
